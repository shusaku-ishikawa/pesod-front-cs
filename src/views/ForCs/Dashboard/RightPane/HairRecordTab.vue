<template>
  <div class="w-full sm:py-3 text-sm">
    ...
    <div v-else>
      ...
      <div
        v-for="(logSet, i) in logByDate.filter(l => (l.frontLog && l.frontLog.image) || (l.topLog && l.topLog.image))"
        :key="i"
...
import { ITask, IAnswerOption, IHairRecord, IPrescript } from "@/types/Interfaces";
