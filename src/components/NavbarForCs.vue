<template>
  <div class="h-10 sm:h-14 fixed top-0 left-0 z-50 shadow w-full text-white" style="background-color: #FF9AA0">
    
    <div class="relative h-full flex items-center px-10">
      <div class="">
        <img src="@/assets/img/Pesod_logo_cs_s.png" alt="" class="h-6">
        <!-- <pix-cardio-logo /> -->
      </div>
